    ...
    Panel: observer(({ store }) => {
        return (
            <div>
                ...
                <button id='custom_add_button_test'>add element</button>
            </div>
        );
    }),
};
...
const sections = [CustomSection, TextSection, BackgroundSection, SizeSection];
...
const addb = store.activePage
console.log(addb)
const addbb = store.activePage.children
console.log(addbb)
// addb.addEventListener("click",sayHI)